        ...
        <div class="mx-auto mt-3" style="width: 90%">
            <div class="row border-bottom">
                ...
                <div class="col align-self-center ms-5 mb-2">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col">
                            <input placeholder="-" type="text" class="form-control-plaintext" :value="getWorkRole"
                                readonly required />
                        </div>
                    </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col">
                            <input placeholder="-" type="text" class="form-control-plaintext" :value="getSection"
                                readonly required />
                        </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col">
                            <input placeholder="-" type="text" class="form-control-plaintext" :value="getDepartment"
                                readonly required />
                        </div>

                        <label for="" class="col-md-2 col-form-label text-gray"> ทีม </label>
                        <div class="col">
                            <input placeholder="-" type="text" class="form-control-plaintext" :value="getTeam" readonly
                                required />
                        </div>
                    </div>
            ...
            <div class="row border-bottom">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col">
                        <input placeholder="-" type="text" class="form-control-plaintext"
                            :value="intern.intn_nickname_th" readonly required />
                    </div>
                </div>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col">
                        <input placeholder="-" type="text" class="form-control-plaintext"
                            :value="intern.intn_nickname_en" readonly required />
                    </div>
                </div>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col">
                        <input v-model="intern.intn_citizen_id" placeholder="-" type="text"
                            class="form-control-plaintext" readonly required />
                    </div>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col">
                        <input v-model="intern.intn_nationality" placeholder="-" type="text"
                            class="form-control-plaintext" readonly required />
                    </div>
            ...
            <div class="row border-bottom">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col">
                        <input v-model="intern.intn_tel" placeholder="-" type="text" class="form-control-plaintext"
                            readonly required />
                    </div>
