...
<template>
  ...
  <SectionSpace>
    <div class="header me-1">
      ...
      <BaseModal
        size="lg"
        v-if="openCreateModel"
        @save="submitForm"
        @close="openCreateModel = false"
      ...
      >
        <div class="row mb-3">
          <div class="col">
            <BaseInput
              ...
              required="required"
              :class="{ 'is-invalid': v$.com_name.$error }"
            />
        ...
        <div class="row mb-3">
          <div class="col">
            <BaseInput
              label="เลขที่"
              input_type="text"
              v-model="companyData.com_address.addr_house_number"
              placeholder="เลขที่"
            />
          </div>
          ...
          <div class="col">
            <BaseInput
              label="หมู่"
              input_type="text"
              v-model="companyData.com_address.addr_village_number"
              placeholder="เลขที่"
            />
          </div>
        </div>
        ...
        <div class="row mb-3">
          <div class="col">
            <BaseInput
              label="ตรอก"
              input_type="text"
              v-model="companyData.com_address.addr_alley"
              placeholder="ตรอก"
            />
          </div>
          ...
          <div class="col">
            <BaseInput
              label="ถนน"
              input_type="text"
              v-model="companyData.com_address.addr_street"
              placeholder="ถนน"
            />
          </div>
        </div>
        ...
        <div class="row mb-3">
          <div class="col">
            <BaseInput
              label="ตำบล/แขวง"
              input_type="text"
              v-model="companyData.com_address.addr_subdistrict"
          ...
          <div class="col">
            <BaseInput
              label="อำเภอ/เขต"
              input_type="text"
              v-model="companyData.com_address.addr_district"
        ...
        <div class="row mb-3">
          <div class="col">
            <BaseInput
              label="สาขา(ชื่อจังหวัด)"
              input_type="text"
              v-model="companyData.com_address.addr_province"
              placeholder="สาขา(ชื่อจังหวัด)"
              required="required"
    ...
    <div class="content_card row mb-2">
      <BaseCard
        hover
        v-for="Company in filterData"
        class="outline-card mt-4"
    ...
    <div class="row mb-3">
      <div class="col">
        <BaseInput
          label="เลขที่"
          input_type="text"
          :value="editedCompany.com_address.addr_house_number"
      ...
      <div class="col">
        <BaseInput
          label="หมู่"
          input_type="text"
          :value="editedCompany.com_address.addr_village_number"
    ...
    <div class="row mb-3">
      <div class="col">
        <BaseInput
          label="ตรอก"
          input_type="text"
          :value="editedCompany.com_address.addr_alley"
      ...
      <div class="col">
        <BaseInput
          label="ถนน"
          input_type="text"
          :value="editedCompany.com_address.addr_street"
    ...
    <div class="row mb-3">
      <div class="col">
        <BaseInput
          ...
          label="ตำบล/แขวง"
          input_type="text"
          :value="editedCompany.com_address.addr_subdistrict"
      ...
      <div class="col">
        <BaseInput
          ...
          label="อำเภอ/เขต"
          input_type="text"
          :value="editedCompany.com_address.addr_district"
    ...
    <div class="row mb-3">
      <div class="col">
        <BaseInput
          ...
          label="สาขา(ชื่อจังหวัด)"
          input_type="text"
          :value="editedCompany.com_address.addr_province"
      ...
      <div class="col">
        <BaseInput
          ...
          label="เลขไปรษณีย์"
          input_type="text"
          :value="editedCompany.com_address.addr_post_code"
