<template>
    ...
    <main class="px-5 pt-4 col" style="margin-left: 280px; margin-top: 63px;">
        ...
        <div class="d-flex mb-3">
            ...
            <button @click="$router.push('/interns/key-data')" class="btn ms-auto outline-red rounded-pill">
            ...
            <button @click="$router.push('/interns/add-file')" class="ms-4 col-auto btn outline-red rounded-pill">
