  ...
  <form @submit.prevent="createInterns">
    <div class="row mt-2 table-wrapper-scroll-y my-custom-scrollbar">
      ...
      <BaseTable
        ...
        <tr v-for="(data, index) in excelData" class="tr-custom border-start border-end border-bottom" @click="checkRow(index)">
          <td>
              <div class="form-check my-auto">
                <input name="tb-check" :id="'tb-check' + index" type="checkbox" @click="checkRow(index)" class="form-check-input mt-2 p-2" @change="unSelectAll" />
          ...
          <td v-if="data.duplicate" class="text-center" @mouseover.once="openTooltip">
            <img src="../../assets/images/warning.png" width="24" alt="" data-bs-toggle="tooltip" data-bs-placement="left"
