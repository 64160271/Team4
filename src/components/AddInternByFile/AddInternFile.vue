...
<template>
    <div class="d-flex flex-column mb-3">
        ...
        <div
id="upload-box"
class="d-flex justify-content-center align-items-center mt-3 upload-box upload">
            <input
id="file"
accept=".xlsx"
type="file"
name=""
@change="showFileName(readDataInFile)" />
...
clip-rule="evenodd"
                ...
                <span
id="filename"
class="row h5 mt-3">เลือกไฟล์ Excel หรือลากไฟล์ที่นี่</span>
            </div>
        </div>
...
class="d-flex mt-5">
            <button
type="button"
class="outline-gray btn"
@click="$router.push('/')">ย้อนกลับ</button>
            <button
type="button"
class="outline-red btn ms-auto"
@click="uploaded()">Import</button>
        </div>
