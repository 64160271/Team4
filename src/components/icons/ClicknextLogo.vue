...
<template>
  <svg
    ...
    width="150.000000pt"
    height="30.000000pt"
    viewBox="0 0 381.000000 82.000000"
  ...
  >
    ...
    >
      <path
        d="M293 796 c-228 -74 -346 -345 -245 -561 76 -161 252 -254 426 -225
      ...
      />
      <path
        d="M1137 626 c-122 -33 -192 -157 -157 -280 34 -123 169 -191 302 -152
      ...
      <path
        d="M1602 624 c-40 -27 -22 -74 28 -74 50 0 68 47 28 74 -12 9 -25 16
                            -28 16 -3 0 -16 -7 -28 -16z"
      />
      <path
        d="M2090 410 l0 -230 40 0 40 0 0 48 c0 38 5 53 23 70 13 12 28 22 34
      ...
      />
      <path
        d="M3618 558 c-3 -39 -6 -43 -30 -46 -24 -3 -28 -8 -28 -33 0 -26 3 -29
      ...
      />
      <path
        d="M333 496 c-33 -30 -37 -38 -37 -85 -1 -48 2 -55 36 -87 31 -28 45
      ...
      <path
        d="M1815 496 c-70 -30 -107 -114 -86 -193 30 -110 182 -155 275 -82 32
      ...
      />
      <path
        d="M2470 345 l0 -165 35 0 35 0 0 95 c0 129 25 175 94 175 68 0 86 -35
                        86 -170 l0 -100 35 0 35 0 0 115 c0 135 -12 175 -61 200 -42 22 -140 17 -169
                        -10 -20 -18 -20 -18 -20 3 0 18 -6 22 -35 22 l-35 0 0 -165z"
      />
      <path
        d="M2933 490 c-106 -64 -102 -229 7 -285 59 -30 142 -26 195 9 25 16 25
      ...
      />
      <path
        d="M3270 430 l60 -79 -66 -86 -65 -85 43 0 c41 0 45 3 82 55 22 30 43
