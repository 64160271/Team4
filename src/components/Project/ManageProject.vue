<template>
    ...
    <BaseModal @close="openModal=false" v-if="openModal==true" size="lg" title="เพิ่มข้อมูลโปรเจกต์">
        <div class="row mb-3">
            <div class="col-md-6">
                <BaseInput label="ชื่อโปรเจกต์" v-model="proj_name" placeholder="ชื่อโปรเจกต์" required />
            </div>
            <div class="col-md-6">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <BaseInput type="date" label="วันที่เริ่มโปรเจกต์" v-model="proj_start_date" />
            </div>
            <div class="col-md-6">
                <BaseInput type="date" label="วันที่สิ้นสุดโปรเจกต์" v-model="proj_end_date" />
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-6">
                <BaseSelect label="พี่เลี้ยงโปรเจกต์" v-model="proj_mentor_id" :options="mentors" text="ment_name" value="ment_id" />
            </div>
            <div class="col-md-6">
                <BaseSelect label="สถานะโปรเจกต์" v-model="proj_status" :options="statusValue" text="text" value="val" />
            </div>
        </div>
    </BaseModal>
</template>
