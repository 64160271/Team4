<template>
    <div class="col-md-5">
        ...
        <div class="row mt-4">
            <button class="mx-auto col-sm-6 btn btn-sm outline-red">
                <svg width="35" height="35" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        stroke="#e1032b" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
    ...
    <div class="col-md-5 mx-auto">
        ...
        <div class="row text-start mb-4">
            ...
            <input type="text" class="form-control" placeholder="example@clicknext.com" required>
        </div>

        <div class="row text-start mb-4">
            <label for="" class="form-label">สถานะพนักงาน <font color="#e1032b">*</font></label>
            <input type="text" class="form-control" placeholder="สถานะพนักงาน" required>
        </div>

        <div class="row text-start mb-4">
            <label for="" class="form-label">ตำแหน่ง <font color="#e1032b">*</font></label>
            <input type="text" class="form-control" placeholder="ตำแหน่ง" required name="" id="">
        </div>
    </div>
</template>
