    ...
    <div class="row mb-3">
      ...
      <div class="col ms-5 align-self-center">
        ...
        <div class="row mb-2 grid">
          ...
          >
          <div class="col me-5">
            <input v-model="formData.id" type="number" class="form-control mb-2" />
          </div>

          <label for="" class="col-2 col-form-label text-gray"
            >สถานะพนักงาน <span class="text-danger">*</span></label
          >
          <div class="col">
            <select v-model="formData.status" class="form-select mb-2">
        ...
        <div class="row mb-2">
          <label for="" class="col-2 col-form-label text-gray"
            >อีเมลพนักงาน <span class="text-danger">*</span></label
          >
          <div class="col me-5">
          ...
          <label for="" class="col-2 col-form-label text-gray"
            >ตำแหน่งงาน <span class="text-danger">*</span></label
          >
          <div class="col">
            <select class="form-select mb-2"></select>
          </div>
        </div>
      </div>
      ...
      <div class="row mb-2">
        <div class="col-2 ms-5">
          <label for="" class="form-label text-gray"
            >คำนำหน้าชื่อ (ไทย) <span class="text-danger">*</span></label
          >
          <select
            id="thprefix"
      ...
      <div class="row mb-4">
        <div class="col-2 ms-5">
          <label for="" class="form-label text-gray"
            >คำนำหน้าชื่อ (อังกฤษ) <span class="text-danger">*</span>
          </label>
          <input type="text" class="form-control" id="enprefix" required />
        </div>

        <div class="col">
          <label for="" class="form-label text-gray"
            >ชื่อจริง (อังกฤษ) <span class="text-danger">*</span></label
          >
          <input v-model="formData.fname[1]" type="text" class="form-control" required />
        </div>

        <div class="col">
          <label for="" class="form-label text-gray"
            >นามสกุล (อังกฤษ) <span class="text-danger">*</span></label
          >
          <input v-model="formData.lname[1]" type="text" class="form-control" required />
        </div>

        <div class="col-2">
          <label for="" class="form-label text-gray">ชื่อเล่น (อังกฤษ)</label>
          <input
            v-model="formData.nickname[1]"
            type="text"
            class="form-control"
            required
          />
      ...
      <div class="row mb-2">
        <label for="" class="col-2 col-form-label ms-5 text-gray"
          >เลขบัตรประชาชน/พาสปอร์ต <span class="text-danger">*</span></label
        >
        <div class="col me-5">
          <input v-model="formData.citizen_id" type="text" class="form-control mb-2" />
        </div>

        <div class="col">
          <div class="row">
            <label for="" class="col-auto col-form-label text-gray"
              >วันเกิด <span class="text-danger">*</span></label
            >
            <input
        ...
        <div class="col-md-2">
          <div class="row">
            ...
            <input
              type="text"
              class="col form-control mb-2"
              :value="getAge(formData.birth_date) || 0"
              readonly
              disabled
            />
          </div>
      ...
      <div class="row mb-2">
        ...
        >
        <div class="col me-5">
          <select v-model="formData.gender" class="form-select mb-2">
        ...
        <label for="" class="col-2 col-form-label text-gray"
          >หมู่เลือด <span class="text-danger">*</span></label
        >
        <div class="col">
          <select v-model="formData.blood_type" class="form-select mb-2">
      ...
      <div class="row mb-2">
        ...
        >
        <div class="col me-5">
          <input v-model="formData.weight" type="text" class="form-control mb-2" />
        </div>

        <label for="" class="col-2 col-form-label text-gray">ส่วนสูง (เซนติเมตร)</label>
        <div class="col">
          <input v-model="formData.height" type="text" class="form-control mb-2" />
        </div>
      </div>

      <div class="row mb-2">
        <label for="" class="col-2 col-form-label ms-5 text-gray"
          >สัญชาติ <span class="text-danger">*</span></label
        >
        <div class="col me-5">
          <input v-model="formData.nationality" type="text" class="form-control mb-2" />
        </div>

        <label for="" class="col-2 col-form-label text-gray"
          >เชื้อชาติ <span class="text-danger">*</span></label
        >
        <div class="col">
          <input v-model="formData.nation" type="text" class="form-control mb-2" />
        </div>
      </div>

      <div class="row mb-4">
        <label for="" class="col-2 col-form-label ms-5 text-gray"
          >ศาสนา <span class="text-danger">*</span></label
        >
        <div class="col me-5">
          <input v-model="formData.religion" type="text" class="form-control mb-2" />
        </div>

        <label for="" class="col-2 col-form-label text-gray">สถานภาพสมรส</label>
        <div class="col">
          <select v-model="formData.martial_status" class="form-select mb-2">
            <option
      ...
      <div class="row mb-4">
        ...
        <div class="col">
          ...
          >
          <select class="form-select mb-2" v-model="formData.major" required>
      ...
      <div class="row mb-4">
        <div class="col ms-5">
          ...
          >
          <select v-model="formData.intern_type" class="form-select mb-2" required>
        ...
        <div class="col-md-3">
          <label for="" class="form-label text-gray"
            >เลขที่สัญญาจ้าง <span class="text-danger">*</span></label
          >
          <input
        ...
        <div class="col">
          ...
          <input v-model="formData.end_date" type="date" class="form-control mb-2" />
        </div>

        <div class="col">
          <label for="" class="form-label text-gray"
            >วันสุดท้ายที่มาทำงาน <span class="text-danger">*</span></label
          >
          <input
        ...
        <div class="col">
          <label for="" class="form-label text-gray"
            >วันที่สิ้นสุดสัญญา <span class="text-danger">*</span></label
          >
          <input
      ...
      <div class="row mb-2">
        ...
        <div class="col">
          <input v-model="formData.post_code" type="text" class="form-control mb-2" />
        </div>
      </div>
      ...
      <div class="row mb-4">
        ...
        >
        <div class="col me-5">
          <input v-model="formData.tel" type="text" class="form-control mb-2" />
        </div>
        ...
        >
        <div class="col">
          <input v-model="formData.email" type="text" class="form-control mb-2" />
        </div>
      </div>
      ...
      <div class="row mb-4">
        ...
        <div class="col me-5">
          <select v-model="formData.military_status" class="form-select mb-2">
            <option
        ...
        <div class="col">
          <input v-model="formData.reason" type="text" class="form-control mb-2" />
        </div>
      </div>
