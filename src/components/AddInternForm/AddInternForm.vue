      ...
      <div class="row border-bottom">
        ...
        <div class="col ms-5 align-self-center">
          ...
          <div class="row gx-5 mb-3">
            ...
            <div class="col-md-6">
              <BaseSelect label="สถานะพนักงาน" :options="statusList.list" v-model="personalInfo.intn_work_status"
      ...
      <div class="container border-bottom">
        ...
        <div class="row mb-4">
          ...
          <div class="col">
            ...
            <input id="contractend" v-model="personalInfo.intn_contract_end_date" type="date" class="form-control" />
          </div>
        </div>
      </div>
