...
<template>
  <form id="form" class="needs-validation" enctype="multipart/form-data" novalidate>
    <LayoutMenuName page-name="เพิ่มนักศึกษาฝึกงาน > กรอกแบบฟอร์ม" />
      ...
      <div class="row mx-auto" style="width: 85%">
        <div class="row border-bottom">
          ...
          <div class="col ms-5 align-self-center">
            ...
            <div class="row gx-5 mb-3">
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input maxlength="4" id="id" v-model="personalInfo.intn_code" placeholder="xxxx" type="text"
                    class="form-control" :class="{ 'is-invalid': v$.personal_info.intn_code.$error }" />
            ...
            <div class="row mb-3 gx-5">
              ...
              <div class="col-md-6">
                <BaseSelect label="พี่เลี้ยง" :options="mentors" v-model="personalInfo.intn_mentor_id" value="ment_id"
                  text="ment_name" placeholder="เลือก (ต้องเลือกฝ่ายก่อน)"
            ...
            <div class="row mb-4 gx-5">
              ...
              <div class="col-md-6">
                <BaseSelect label="ทีม" :options="teams" v-model="workInfo.work_team_id" value="team_id" text="team_name"
                  placeholder="เลือก (ต้องเลือกฝ่ายก่อน)" :class="{ 'is-invalid': v$.work_info.work_team_id.$error }"
                  required />
        ...
        <div class="container border-bottom">
          ...
          <div class="row mb-3">
            <div class="col-md-2">
              ...
              <select id="thprefix" class="form-select" :class="{ 'is-invalid': v$.personal_info.intn_prefix_th.$error }"
                @change="changePrefix($event.target.value)" required>
                <option disabled selected value="">เลือก</option>
          ...
          <div class="row mb-3">
            ...
            <div class="col gx-5">
              ...
              <input id="fname_en" v-model="personalInfo.intn_fname_en" placeholder="Somsri" type="text"
                class="form-control" :class="{ 'is-invalid': v$.personal_info.intn_fname_en.$error }" />
          ...
          <div class="row mb-3 gx-5">
            ...
            <div class="col">
              ...
              <input type="text" class="form-control" :value="getAge(personalInfo.intn_birth_date) || 0" readonly disabled
          ...
          <div class="row mb-3 gx-5">
            ...
            <div class="col">
              ...
              <input id="nation" v-model="personalInfo.intn_nation" placeholder="ไทย" type="text" class="form-control" />
            </div>
          </div>
        ...
        <div class="container border-bottom">
          ...
          <div class="row mb-4">
            ...
            <div class="col">
              <BaseSelect label="สาขาวิชา" :options="majors" v-model="personalInfo.intn_major_id" value="maj_id"
                text="maj_name" placeholder="เลือก (ต้องเลือกคณะก่อน)"
                :class="{ 'is-invalid': v$.personal_info.intn_major_id.$error }" required />
          ...
          <div class="row mb-3">
            <div class="col-md-6">
              <BaseSelect label="ประเภทพนักงาน" :options="internTypeList.list" v-model="personalInfo.intn_intern_type"
                :class="{ 'is-invalid': v$.personal_info.intn_intern_type.$error }" required disabled />
        ...
        <div class="container border-bottom">
          ...
          <div class="row mb-3 gx-5">
            <div class="col">
              ...
              <input v-model="address.addr_village_number" type="number" class="form-control" />
            </div>
          ...
          <div class="row mb-3 gx-5">
            <div class="col">
              ...
              <input id="district" v-model="address.addr_subdistrict" type="text" class="form-control" />
            </div>

            <div class="col">
              <label for="" class="form-label text-gray">อำเภอ / เขต</label>
              <input id="amphoe" v-model="address.addr_district" type="text" class="form-control" />
            </div>
          </div>
          ...
          <div class="row mb-3 gx-5">
            <div class="col">
              ...
              <input id="province" v-model="address.addr_province" type="text" class="form-control" />
            </div>

            <div class="col">
              <label for="" class="form-label text-gray">รหัสไปรษณีย์</label>
              <input id="zipcode" v-model="address.addr_post_code" type="number" class="form-control" />
            </div>
          </div>
        ...
        <div class="container border-bottom">
          ...
          <div class="row mb-4 gx-5">
            ...
            <div class="col">
              ...
              <div class="col">
                <input id="reason" v-model="personalInfo.intn_reason" type="text" class="form-control" />
              </div>
            </div>
          </div>
        </div>
