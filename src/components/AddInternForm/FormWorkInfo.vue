...
:value="mentor">{{ mentor.ment_fname + " " + mentor.ment_lname }}</option>
            </select>
        </div>
    </div>
...
:value="secton">{{ section.sec_name }}</option>
            </select>
        </div>
    </div>
...
:value="department">{{ department.dept_name }}</option>
    ...
    <div class="row mb-4">
        <div class="col">
            <label
for=""
class="form-label">ตำแหน่งงาน</label>
            <select
id="position"
v-model="data.role"
name="position"
